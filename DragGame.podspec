#
#  Be sure to run `pod spec lint DragGame.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.name         = "DragGame"
  s.version      = "0.0.1"
  s.summary      = "A short description of DragGame."
  ...
  # s.authors      = { "加賀江 優幸" => "math16.music25@gmail.com", "other author" => "email@address.com" }
  # s.author       = '加賀江 優幸', 'other author'
  ...
  s.source       = { :git => "http://github.com/yuutetu/DragGame.git", :tag => "0.0.1" }
